...
export const dateArr = [
  { id: 1, description: "all years", requestValue: "", checked: true }, //default date
  {
    id: 2,
    description: "2020-",
    requestValue: "primary_release_date.gte=2020-01-01",
    checked: false,
  },
  ...[...new Array(10)].map((year, ind) => ({
    id: ind + 3,
    description: `${2010 - 10 * ind} - ${2020 - 10 * ind}`,
    requestValue: `primary_release_date.gte=${
      2010 - 10 * ind
    }-01-01&primary_release_date.lte=${2020 - 1 - 10 * ind}-12-30`,
    checked: false,
  })),
];
...
export const sortedArr = [
  {
    ...
    requestValue: "popularity.desc&vote_count.gte=50",
    checked: true,
  }, //default sorting
  {
    id: 2,
    description: "Vote average",
    requestValue: "vote_average.desc&vote_count.gte=1000",
    checked: false,
  },
  {
    id: 3,
    description: "Vote count",
    requestValue: "vote_count.desc&vote_count.gte=50",
    checked: false,
  },
  {
    id: 4,
    description: "Release date",
    requestValue: `primary_release_date.desc&vote_count.gte=50`,
    checked: false,
  },
];
...
export function getMoviesList(
  ...
  const URL = `https://api.themoviedb.org/3/discover/movie?page=${page}${
    movieFilters || "&"
  }sort_by=${sorted}&api_key=${API_KEY}`;
