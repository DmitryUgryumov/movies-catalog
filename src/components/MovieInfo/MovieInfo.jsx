...
const checkArr = (arr) =>
  Array.isArray(arr) && arr.length
    ? arr.map((item) => (
        <span className="info__span" key={item.id || item.name}>
          {item.name}
        </span>
      ))
    : "—";
...
const numberCalculate = (n, symbol = "") =>
  n ? n.toLocaleString() + ` ${symbol}` : "—";
    ...
    <div className="movie__info info">
      ...
      <div className="info__description">
        ...
        <ul className="info__ul">
          ...
          <li className="info__li">
            <p>Rating: </p>
            <p className="info__rating">{`${checkStr(
              movie.vote_average
            )} (${numberCalculate(movie.vote_count, "votes")})`}</p>
          </li>
          ...
          <li className="info__li">
            ...
            <p className="info__countries">
              {checkArr(movie.production_countries)}
            </p>
          </li>

          <li className="info__li">
            <p>Budget: </p>
            <p className="info__budget">{`${numberCalculate(
              movie.budget,
              "$"
            )}`}</p>
          </li>
          ...
          <li className="info__li">
            <p>Revenue: </p>
            <p className="info__revenue">{`${numberCalculate(
              movie.revenue,
              "$"
            )}`}</p>
          </li>
          ...
          <li className="info__li">
            <p>Realise date:</p>
            <p className="info__release_date">
              {dateCalculate(movie.release_date)}
            </p>
          </li>
